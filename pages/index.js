          ...
          <div className="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-wrap">
            <div className="my-3 p-3">
              ...
              <Link href="https://spca.org/support-us/volunteer/ways-to-volunteer/">
                <a target="_blank" className="learn-btn btn btn-outline-secondary">Learn More</a>
              </Link>
            </div>
          ...
          <div className="side-card me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
            <div className="my-3 p-3">
              ...
              <Link href="https://spca.org/resources/help-animals/report-abuse/animal-cruelty-complaint/">
                <a target="_blank" className="view-btn btn btn-outline-secondary">Report Abuse</a>
              </Link>
            </div>
            <div className="bg-light shadow-sm mx-auto"></div>
          </div>
        ...
        >
          ...
          <div className="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
            <div className="my-3 p-3">
              ...
              <Link href="https://spcaoftexas3.securevetsource.com/site/view/182142_HomeDelivery.pml">
                <a target="_blank" className="text-link">Browse and Shop</a>
              </Link>
            </div>
            <div className="bg-dark shadow-sm mx-auto"></div>
          </div>
          <div className="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
            <div className="my-3 p-3">
              ...
              <Link href="https://www.spca.org/resources/pet-needs/pet-tips-training/">
                <a target="_blank" className="text-link">Get Expert Help for Your Animal</a>
              </Link>
            </div>
            <div className="bg-light shadow-sm mx-auto"></div>
          </div>
          <div className="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
            <div className="my-3 py-3">
              ...
              <Link href="https://www.spca.org/resources/pet-needs/lost-found/">
                <a target="_blank" className="text-link">Get Fast Help for a Lost Animal</a>
              </Link>
            </div>
            <div className="bg-dark shadow-sm mx-auto"></div>
          </div>
          ...
          <div className="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
            <div className="my-3 p-3">
              ...
              <Link href="https://www.spca.org/resources/pet-needs/support-to-keep-your-pet/">
                <a target="_blank" className="text-link">Learn How We Can Help</a>
              </Link>
            </div>
            <div className="bg-light shadow-sm mx-auto"></div>
          </div>
          ...
          <div className="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
            <div className="my-3 p-3">
              ...
              <Link href="https://www.spca.org/resources/pet-needs/rehome/">
